...
const resumeData = {
  ...
  summary: `<strong>4年WebGIS全栈开发经验 + 地理信息系统统招硕士（专业成绩前5%）</strong>；独立落地1套企业级LLM‑Agent项目、2套AI Agent演示项目；具备二三维GIS商业项目完整交付经验，2个项目实现前后端独立全栈开发；掌握LangGraph多智能体编排、混合RAG检索、多模态语音交互、RBAC行级权限、Docker容器化与双CI/CD工程体系；具备从需求、架构设计、核心逻辑开发、测试治理到上线部署全链路能力。企业项目量化成果：问答准确率提升50%，任务下发效率提升20%，接口响应延迟缩短35%，线上排障效率提升60%+。`,

  expSummary:
    "拥有GIS与AI两大领域沉淀，<b>2个商业项目完成前后端独立全栈开发</b>，可独立承担需求梳理、数据库设计、接口开发、前端实现、部署验收完整流程；早期积累大量Cesium/OpenLayers二三维GIS商业项目，熟悉遥感、无人机、数字孪生大屏业务；研究生阶段深耕深度强化学习多智能体算法；研究生毕业后期转型大模型应用开发，完成多套Agent系统工程化落地，能够打通GIS空间业务与大模型智能体的融合开发。",
