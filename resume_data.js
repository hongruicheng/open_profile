...
const resumeData = {
  ...
  projects: [
    ...
    },
    {
      ...
      aiPoints: [],
      frontendPoints: [
        "哨兵气象遥感自动化处理平台：Django+Vue3 全栈开发遥感影像平台，支持哨兵卫星影像检索、批量下载、自动化预处理与任务状态管理。",
  ...
  jobs: [
    {
      ...
      points: [
        ...
        "共计完成1个产品研发，落地多套AI Agent演示项目",
        "2026.07 部门裁撤，离职后重构平台，开源项目地址：https://gitee.com/hongruichen/xinhe‑project‑made‑open‑source-1",
        "2026.08 自行构建HealthAgent多模态健康管理中台，独立完成LangGraph多智能体编排、混合RAG检索、STT/TTS语音三明治架构、RBAC行级权限、飞书等定时消息推送等核心逻辑开发，落地可演示的多模态健康助手管理系统",
        "2026.09 自行构建A2A多智能体协作平台开发，独立完成路由、流水线、Map‑Reduce并行、协商四大编排模式核心逻辑开发，落地多智能体协作工程化平台",
        "目前已完成3个产品研发见gitee，预估落地2套AI Agent项目以上"
      ],
    },
    {
    ...
    },
    {
      ...
      points: [
        ...
        "全国疫情严重，公司业务线缩减，批量裁员，本人被裁后 3 个月备考上岸全日制硕士研究生。",
        "共计完成2个公司旧项目重构，2个产品研发，1个公司官网/App端开发"
      ],
    },
    {
